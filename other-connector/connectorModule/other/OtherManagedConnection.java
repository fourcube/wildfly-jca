...
/**
 * OtherManagedConnection
 *
 * @version $Revision: $
 */
public class OtherManagedConnection implements ManagedConnection
{
   /** The logger */
   private static Logger log = Logger.getLogger("OtherManagedConnection");
    ...
    * @param mcf mcf
    */
   public OtherManagedConnection(OtherManagedConnectionFactory mcf)
   {
      this.mcf = mcf;
      this.logWriter = null;
   ...
   {
      connection = new OtherConnectionImpl(this, mcf);
   ...
   {
      return new OtherManagedConnectionMetaData();
   }
    ...
    */
   void closeHandle(OtherConnection handle)
   {
